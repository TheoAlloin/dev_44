...
">
                                                <span style="color:white!important"><?php echo smartyTranslate(array('s'=>'Yes','mod'=>'productcomments'),$_smarty_tpl);?>
</span>
                                            </button>
...
">
                                                <span style="color:white!important"><?php echo smartyTranslate(array('s'=>'No','mod'=>'productcomments'),$_smarty_tpl);?>
</span>
                                            </button>
                                        </li>
                                    <?php }?>
...
">
            ...
            <?php if ((!$_smarty_tpl->tpl_vars['too_early']->value&&($_smarty_tpl->tpl_vars['is_logged']->value||$_smarty_tpl->tpl_vars['allow_guests']->value))) {?>
                ...
                <p class="align_center">
                    <a id="new_comment_tab_btn" class="btn btn-default button button-small open-comment-form" href="#new_comment_form">
                        <span style="color:white!important"><?php echo smartyTranslate(array('s'=>'Write your review!','mod'=>'productcomments'),$_smarty_tpl);?>
</span>
                    </a>
                </p>
            <?php }?>
        <?php } else { ?>
            <?php if ((!$_smarty_tpl->tpl_vars['too_early']->value&&($_smarty_tpl->tpl_vars['is_logged']->value||$_smarty_tpl->tpl_vars['allow_guests']->value))) {?>
                ...
                <p class="align_center">
                    <a id="new_comment_tab_btn" class="btn btn-default button button-small open-comment-form" href="#new_comment_form">
                        <span style="color:white!important"><?php echo smartyTranslate(array('s'=>'Be the first to write your review!','mod'=>'productcomments'),$_smarty_tpl);?>
</span>
                    </a>
                </p>
            <?php } else { ?>
...
<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
    <div class="primary_block row">
        <div id="devis_form" class="expand">
            <h2 class="devis_heading">Ce produit m'intéresse</h2>
            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayPowerfulForm','mod'=>'powerfulformgenerator','id'=>2),$_smarty_tpl);?>
