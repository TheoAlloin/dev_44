<?php /* Smarty version Smarty-3.1.19, created on 2017-09-22 16:06:21
         compiled from "/var/www/44.dev.dfx.fr/www/themes/jlcw/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:58262934259c518dd4d88e7-53089529%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '74ec887240f289b6e6655b75c6d53aa9178d9bb3' => 
    array (
      0 => '/var/www/44.dev.dfx.fr/www/themes/jlcw/product.tpl',
      1 => 1505739010,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '58262934259c518dd4d88e7-53089529',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c518dd71e9b2_51399393',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c518dd71e9b2_51399393')) {function content_59c518dd71e9b2_51399393($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/44.dev.dfx.fr/www/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_math')) include '/var/www/44.dev.dfx.fr/www/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/44.dev.dfx.fr/www/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/var/www/44.dev.dfx.fr/www/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/44.dev.dfx.fr/www/tools/smarty/plugins/modifier.date_format.php';
?>
					...
					<?php }?>
                                        <?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?>
                                                ...
                                                <section class="page-product-box">
                                                    <h2 class="product_desc">Description du produit : </h2>
                                                        <!-- full description -->
                                                        <div  class="rte"><ul class="product_caracteristic"><li><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['product']->value->description,' - ','</li><li>');?>
</ul></div>
                                                </section>
                                                <!--end  More info -->
                                        <?php }?>
...
" <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> checked="checked"<?php }?> />
			...
			<?php }?>
                        <div id="product_reassurance">
                                <ul>
                                    <li class="retrait_mag"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/revendeurs.png" /><div>Disponible chez<br />nos <strong>revendeurs</strong></div></li>
                                    <li class="livraison_domicile"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/pro.png" /><div>Produit utilisé <br />par des <strong>champions</strong></div></li>
                                    <li class="made_in_france"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/france_2.png" /><div>Conception<br /><strong>Française</strong></div></li>
                                </ul>
                        </div>
		...
		<!-- end center infos-->
		<!-- pb-right-column-->
                <div class="pb-right-column col-xs-12 col-md-3 <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> catalog <?php }?> ">
                        <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
                            <div id="demandez_un_devis"><a href="#devis_form" class="js-scrollTo"><i class="icon-shopping-cart"></i>Ce produit m'intéresse</a></div>
                            <a id="revendeurs" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getCMSLink('9','nos-revendeurs'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Nos revendeurs'),$_smarty_tpl);?>
"><i class="icon-map-marker"></i><?php echo smartyTranslate(array('s'=>'Liste de nos revendeurs'),$_smarty_tpl);?>
</a>
                        <?php }?>
<?php if (($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value))||isset($_smarty_tpl->tpl_vars['groups']->value)||$_smarty_tpl->tpl_vars['product']->value->reference||(isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)) {?>
			<!-- add to cart form-->
			<form id="buy_block" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart'), ENT_QUOTES, 'UTF-8', true);?>
" method="post">
				<!-- hidden datas -->
				<p class="hidden">
