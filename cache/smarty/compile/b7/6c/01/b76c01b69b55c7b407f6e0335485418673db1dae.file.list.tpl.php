<?php /* Smarty version Smarty-3.1.19, created on 2017-09-21 17:19:14
         compiled from "/var/www/44.dev.dfx.fr/www/modules/ph_simpleblog/views/templates/front/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139186120659c3d8722732c0-87313358%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b76c01b69b55c7b407f6e0335485418673db1dae' => 
    array (
      0 => '/var/www/44.dev.dfx.fr/www/modules/ph_simpleblog/views/templates/front/list.tpl',
      1 => 1503997560,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '139186120659c3d8722732c0-87313358',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c3d8722b1376_01851013',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c3d8722b1376_01851013')) {function content_59c3d8722b1376_01851013($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/var/www/44.dev.dfx.fr/www/tools/smarty/plugins/function.cycle.php';
?>
...
">
			<?php echo smartyTranslate(array('s'=>'Actualites','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
...
" itemprop="contentUrl">
									<?php if ($_smarty_tpl->tpl_vars['blogLayout']->value=='full') {?>
										<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['banner'], ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
" class="img_blog" itemprop="thumbnailUrl" />
									<?php } else { ?>
...
">
						...
						<?php } else { ?>
							...
							<?php }?>
                                                        <a class="read_more_button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Permalink to','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
">
