                                    ...
                                    {if !$comment.customer_advice}
                                        <li class="comment_report">
                                            ...
                                            <button class="usefulness_btn btn btn-default button button-small" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
                                                <span style="color:white!important">{l s='Yes' mod='productcomments'}</span>
                                            </button>
                                            <button class="usefulness_btn btn btn-default button button-small" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
                                                <span style="color:white!important">{l s='No' mod='productcomments'}</span>
                                            </button>
                                        </li>
                                    {/if}
            ...
            {if (!$too_early AND ($is_logged OR $allow_guests))}
                ...
                <p class="align_center">
                    <a id="new_comment_tab_btn" class="btn btn-default button button-small open-comment-form" href="#new_comment_form">
                        <span style="color:white!important">{l s='Write your review!' mod='productcomments'}</span>
                    </a>
                </p>
            {/if}
        {else}
            {if (!$too_early AND ($is_logged OR $allow_guests))}
                ...
                <p class="align_center">
                    <a id="new_comment_tab_btn" class="btn btn-default button button-small open-comment-form" href="#new_comment_form">
                        <span style="color:white!important">{l s='Be the first to write your review!' mod='productcomments'}</span>
                    </a>
                </p>
            {else}
