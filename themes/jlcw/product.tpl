...
{*			<p id="product_reference"{if empty($product->reference) || !$product->reference} style="display: none;"{/if}>
                                        ...
                                        {if isset($product) && $product->description}
                                                ...
                                                <section class="page-product-box">
                                                    <h2 class="product_desc">Description du produit : </h2>
                                                        <!-- full description -->
                                                        <div  class="rte"><ul class="product_caracteristic"><li>{$product->description|replace:' - ':'</li><li>'}</ul></div>
                                                </section>
                                                <!--end  More info -->
                                        {/if}
			...
			{/if}
                        <div id="product_reassurance">
                                <ul>
                                    <li class="retrait_mag"><img src="{$img_dir}/revendeurs.png" /><div>Disponible chez<br />nos <strong>revendeurs</strong></div></li>
                                    <li class="livraison_domicile"><img src="{$img_dir}/pro.png" /><div>Produit utilisé <br />par des <strong>champions</strong></div></li>
                                    <li class="made_in_france"><img src="{$img_dir}/france_2.png" /><div>Conception<br /><strong>Française</strong></div></li>
                                </ul>
                        </div>
...
*}		<!-- end center infos-->
		<!-- pb-right-column-->
                <div class="pb-right-column col-xs-12 col-md-3 {if $PS_CATALOG_MODE} catalog {/if} ">
                        {if $PS_CATALOG_MODE}
                            <div id="demandez_un_devis"><a href="#devis_form" class="js-scrollTo"><i class="icon-shopping-cart"></i>Ce produit m'intéresse</a></div>
                            <a id="revendeurs" href="{$link->getCMSLink('9', 'nos-revendeurs')|escape:'html'}" title="{l s='Nos revendeurs'}"><i class="icon-map-marker"></i>{l s='Liste de nos revendeurs'}</a>
                        {/if}
{if ($product->show_price && !isset($restricted_country_mode)) || isset($groups) || $product->reference || (isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS)}
						...
						<div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
							<p id="add_to_cart" class="buttons_bottom_block no-print">
								<button type="submit" name="Submit" class="exclusive">
									<span>{if $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}{else}Commander{/if}</span>
								</button>
							</p>
						</div>
       ...
       {* {if $PS_CATALOG_MODE}
            <div class="primary_block row">
                <div id="devis_form" class="expand">
                    <h2 class="devis_heading">Demandez un devis</h2>
                    {hook h='displayPowerfulForm' mod='powerfulformgenerator' id=2}
                </div>
            </div>
        {/if} *}
