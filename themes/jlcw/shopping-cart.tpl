...
{if isset($empty)}
    <div id="empty_cart">
        <p class="alert alert-warning">OUPS ! Il semblerait que votre panier soit vide !</p>
        <img src="{$img_dir}panier_vide.png" />
        <p id="retour_accueil_panier"><a href="/">Accueil <i class="icon-chevron-right"></i></a></p>
    </div>
					...
					{else}
						<tr class="cart_total_price">
							...
							<td colspan="{$col_span_subtotal}" class="text-right">
								{l s='Total products'}
								(<span class="hookDisplayProductPriceBlock-price" id="HOOK_DISPLAY_PRODUCT_PRICE_BLOCK">TTC</span>)
							</td>
