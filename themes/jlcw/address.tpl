...
{*			{if $field_name eq 'vat_number'}
			...
			{if $field_name eq 'postcode'}
				...
				<div class="required postcode form-group unvisible col-xs-12 col-md-4">
			...
			{if $field_name eq 'city'}
				<div class="required form-group col-xs-12 col-md-4">
		...
		{if isset($one_phone_at_least) && $one_phone_at_least && !$atLeastOneExists}
			<p class="inline-infos required">{l s='You must register at least one phone number.'}</p>
		{/if}
		<div class="required form-group col-xs-12 col-md-12" id="adress_alias">
