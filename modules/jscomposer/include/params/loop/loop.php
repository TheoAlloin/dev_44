...
//		$this->args['tag__not_in'] = $not_in;
	...
	public function build() {
		...
		$sql .= " INNER JOIN "._DB_PREFIX_."smart_blog_post_category sbpc ON sbpc.id_smart_blog_post=sbp.id_smart_blog_post";
		$sql .= " INNER JOIN "._DB_PREFIX_."smart_blog_post_tag sbpt ON sbpt.id_post=sbp.id_smart_blog_post";
