...
{else}
	...
	<form id="pfg-form-{$form_id|escape:'quotes':'UTF-8'}" action="{$request_uri|escape:'quotes':'UTF-8'}" method="post" class="std pfg-forms" enctype="multipart/form-data">yeayea
